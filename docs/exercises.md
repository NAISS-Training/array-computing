...
- [Open solution template in Compiler explorer](https://godbolt.org/z/qYa6dTrqf)
...
- Verify that `A v = lambda v` for each eigenvalue-eigenvector pair.
...
!!! tip
    ...
    - [img: single-header-only C++ image library with Eigen interoperability](https://github.com/ThibaultLejemble/img)
